...
string_combined_700_lookup = read_json_from(f"{PATH_ROOT}/data_sources/StringDB/StringDB_combined_700_validation.json")
gtex_090_lookup = read_json_from(f"{PATH_ROOT}/data_sources/GTEX/GTEx_gene_tpm_pancreas_only_filtered_overlap_string_corr_list.json")
...
lookup_list = [string_combined_700_lookup,gtex_090_lookup]
...
def eval_relation(protein1,protein2):
    ...
    for lookup in lookup_list:
        ...
        try:
            relation_score = lookup['relations'][protein1][protein2]
        except KeyError:
            pass
